...
of the intra-operative surgical monitoring industry in which the project
lead (ASG) has worked for several years. Each individual company has a
dataset that by itself is inadequate for machine learning algorithms,
but several such company datasets together, can provide insights. Yet
...
provenance and traceable, controlled compute-to-data. The proposed
paradigm should include an inexpensive, decentralized storage solution
(e.g. Filecoin), absolute control of data in the hands of the individual
...
monetization of their data on the Ocean Marketplace, while ensuring
...
project lead is based, is at the forefront of this field and sets the
