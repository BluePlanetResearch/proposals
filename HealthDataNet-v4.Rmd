...
Ongoing discussions with several current Ocean Protocol grantees active in the healthcare space. Consulting with the Project guiding WG
...
The project lead has published two test datasets (vital_signs_1 & 2) on the Ocean Marketplace using the Rinkeby network. He is currently working publishing an appropriate compute-to-data ML algorithm. To achieve this, he is contributing to the Algovera AI hacking sessions actively.
